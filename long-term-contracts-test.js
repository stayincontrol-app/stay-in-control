...
const activePropertyId=()=>String(localStorage.getItem("system-control-test2-preferred-property-v1")||localStorage.getItem("stay-control-selected-property-v1")||"");
...
function initContracts(){
 ...
 <div class="field field-wide"><label>Endereço completo do imóvel alugado</label><input name="rentalAddress" required placeholder="Rua, número, complemento, bairro"></div>
 <div class="field"><label>Cidade do imóvel</label><input name="rentalCity" required></div><div class="field"><label>Estado</label><input name="rentalState" required></div><div class="field"><label>CEP</label><input name="rentalZip"></div>
