(() => {
  ...
  if (specialAuthFlow() && !/\/invite\.html$/.test(location.pathname)) {
    location.replace("./invite.html" + location.search + location.hash);
    return;
  }
  if (
    !/\/test2-login\.html$/.test(location.pathname) &&
    !specialAuthFlow() &&
    !hasSessionToken()
  ) {
  ...
  const supportLabels = {
    "pt-BR": ["Central de Atendimento", "Central de Atendimento pelo WhatsApp"],
    en: ["Support Center", "Support Center on WhatsApp"],
    es: ["Centro de Atención", "Centro de Atención por WhatsApp"],
    fr: ["Centre d’assistance", "Centre d’assistance sur WhatsApp"],
    de: ["Support-Center", "Support-Center über WhatsApp"],
    it: ["Centro Assistenza", "Centro Assistenza su WhatsApp"],
    "pt-PT": ["Centro de Atendimento", "Centro de Atendimento pelo WhatsApp"],
    "zh-CN": ["客服中心", "WhatsApp 客服中心"],
    ja: ["サポートセンター", "WhatsApp サポートセンター"],
    ko: ["고객 지원 센터", "WhatsApp 고객 지원 센터"],
  };
  function currentLang() {
    try {
      return (
        JSON.parse(localStorage.getItem(LANG_KEY) || "{}").language || "pt-BR"
      );
    } catch {
      return "pt-BR";
    }
  ...
  function watchInitialMenu() {
    if (applyUnifiedMenuImmediately()) return;
    const o = new MutationObserver(() => {
      if (applyUnifiedMenuImmediately()) o.disconnect();
    });
    o.observe(document.body, { childList: true, subtree: true });
  }
  function removePageShare() {
    document
      .querySelectorAll("#t2PageShareBar,[data-t2-page-share],.t2-page-share")
      .forEach((n) => n.remove());
  }
  function loadStableSuite() {
    if (!document.querySelector("link[data-t2-suite]")) {
      const l = document.createElement("link");
      l.rel = "stylesheet";
      l.href = "./test2-suite.css";
      l.dataset.t2Suite = "1";
      document.head.append(l);
    }
    ...
    loadCss("./test2-contract-legibility.css?v=20260924-readable2", "contract-legibility");
    loadScriptsInBatches([
      ...
      ["./test2-report.js?v=20260918-report-share5", "report"],
      ...
      [
        "./test2-unified-invite-user.js?v=20260915-final",
        "unified-invite-user",
      ],
      ...
      ["./test2-super-dashboard-v2.js?v=20260921-sponsored-net-v2", "super-dashboard-v2"],
      ["./test2-sponsored-floating.js?v=20260921-6s-3m", "sponsored-floating"],
      ...
      [
        "./test2-unified-page-content.js?v=20260915-final",
        "unified-page-content",
      ],
      ["./test2-owners-live.js?v=20260912-2141", "owners-live"],
      [
      ...
      ["./test2-i18n-unified.js?v=20260924-account-language", "i18n-unified"],
      [
  ...
  window.SystemControlTest2 = {
    name: NAME,
    supportPhone: "+1 (561) 275-6810",
    runtimeMode: "unified-navigation",
  };
})();
